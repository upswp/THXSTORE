...
| 프로젝트 핵심 기능 개발<br />**(v1.0.0)**  |  2021.05.17<br />~<br />2021.05.23  | - **박대현**<br/>  - openvidu 기술 접목을 해서 라이브 영상 송출 및 채팅 기능 구현<br />- 타임딜 진행 중인 가게  정보, 메뉴, 라이브, 주문, 리뷰 페이지 구현<br />- 주문 생성 시 판매자 페이지에 실시간으로 정보 전송 기능 구현<br />- 판매자가 주문 상태 변경하는 기능 구현<br />- 판매자 라이브, 리뷰 페이지 구현<br />- **성정욱**<br />- 타임딜 진행 중인 가게  정보, 메뉴, 리뷰 페이지 구현<br />- 사용자 리뷰 목록 조회 기능 구현<br />- 판매자 리뷰 답변 기능 구현<br />- 스토어 예약 관리 기능 구현<br />- 판매자 스토어 리뷰 관리 페이지 구현<br />- 사용자용 스토어 소개 & 메뉴 페이지 기능 구현, 카카오맵 연동 | - **박상우**<br />- 회원 관련 기능 리펙토링<br />- 이메일 인증을 통한 비밀번호 찾기<br />- 회원 위치 정보 업데이트 기능<br />- Redis 설정<br />- refresh token 기한 설정<br />- **최동식**<br />- 음식점과의 거리에 따른 기능 개발<br />- 라이브 커머스, 채팅 기능 개발<br />- 사용자 관점의 타임딜 스토어<br />- 타임딜, 상품 관련 리팩토링<br />- 메뉴 기본 기능 구현<br />-**황영준**<br />- 주문 시 재고 관련 처리<br />- 타임딜 주문, 리뷰 관련 리팩토링<br />- 주문 상황에 따른 상태변경 적용<br />- 사용자 - 사장님의 주문 플로우 구체화 및 로직 구현<br />- 기존 로직 쿼리문 줄이기, 최적화 작업 진행 |
